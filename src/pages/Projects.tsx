    ...
    return (
        <>
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="space-y-16 sm:space-y-32 py-8 sm:py-12"
            >

                {/* Main Feature - Nexora */}
                <motion.section variants={itemVariants} className="space-y-6 sm:space-y-8">
                    <header className="space-y-2 border-l-2 border-primary pl-4 sm:pl-6">
                        <motion.span
                            initial={{ opacity: 0, x: -10 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: 0.6, duration: 0.8 }}
                            className="text-accent text-xs sm:text-sm font-mono tracking-wider uppercase"
                        >
                            Primary Focus
                        </motion.span>
                        <h2 className="text-3xl sm:text-5xl font-bold text-primary tracking-tight">Nexora</h2>
                        <p className="text-lg sm:text-xl text-secondary max-w-xl">
                            A complex social graph engine exploring real-time interaction and permission logic.
                        </p>
                    </header>

                    <div className="grid gap-8 sm:gap-12 grid-cols-1 sm:grid-cols-12 pt-4 sm:pt-8">
                        <div className="sm:col-span-8 space-y-6 sm:space-y-8">
                            <div className="space-y-2 sm:space-y-3">
                                <h3 className="text-xs sm:text-sm font-semibold text-primary uppercase tracking-wider">The Engineering Challenge</h3>
                                <p className="text-secondary text-base sm:text-lg leading-relaxed text-balance">
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                <h3 className="text-xs sm:text-sm font-semibold text-primary uppercase tracking-wider">System Internals</h3>
                                <ul className="list-disc list-outside ml-4 text-secondary space-y-1 sm:space-y-2 text-sm sm:text-base">
                        ...
                        <div className="sm:col-span-4 flex flex-col justify-end space-y-6 border-t sm:border-t-0 sm:border-l border-border pt-6 sm:pt-0 sm:pl-8">
                            <div>
                                <h4 className="text-sm text-secondary uppercase tracking-widest mb-3">Stack</h4>
                            ...
                            <a href="https://github.com/ranaji114" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary hover:text-accent transition-colors font-medium">
                                <Github size={20} />
                                View Source
                            </a>
                        </div>
                ...
                <motion.section variants={itemVariants} className="space-y-12">
                    <h3 className="text-2xl font-semibold text-primary/50">Foundation Logs</h3>
